...
```
python cs285/scripts/run_hw4_mb.py --exp_name q2_obstacles_singleiteration --env_name obstaclescs285-v0 \ 
    --add_sl_noise --num_agent_train_steps_per_iter 20 --n_iter 1 --batch_size_initial 5000 \ 
...
python cs285/scripts/run_hw4_mb.py --exp_name q4_reacher_numseq100 --env_name reacher-cs285-v0 \ 
    ...
    --n_iter 15 --mpc_num_action_sequences 100 --mpc_action_sampling_strategy 'random' --seed 6
...
python cs285/scripts/run_hw4_mb.py --exp_name q4_reacher_numseq1000 --env_name reacher-cs285-v0 
    ...
    --mpc_action_sampling_strategy 'random' --seed 6
